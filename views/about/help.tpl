...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12 terms">
			<h1 class="agree-page-title">Help Section</h1>
			
			<h2 class="agree-title">Registration</h2>
			<p class="agree-text">
			In order to register on the website you have to click on the button located on the top-right : <img src="{$URL_STATIC}img/register-button.png" alt="Register on Share to World" class="help-button"/>
			<br/>
